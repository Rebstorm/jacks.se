            ...
            >
                ...
                >
                    ...
                    <g className="pillar-alive" filter="url(#drop)">
                        {/* feet (little pads) */}
                        <g className="feet">
                            <rect x="38" y="88" width="16" height="8" rx="4" className="foot foot--1"/>
                            <rect x="62" y="90" width="16" height="8" rx="4" className="foot foot--2"/>
                            <rect x="86" y="92" width="16" height="8" rx="4" className="foot foot--3"/>
                            <rect x="110" y="92" width="16" height="8" rx="4" className="foot foot--4"/>
                            <rect x="134" y="90" width="16" height="8" rx="4" className="foot foot--5"/>
                            <rect x="158" y="88" width="16" height="8" rx="4" className="foot foot--6"/>
                        </g>
                        ...
                        <g className="face">
                            ...
                            <path d="M166 70 q6 6 16 0" fill="none" stroke="#1b1b1b" stroke-width="3"
                    ...
                    <g className="pillar-flat" style="display:none">
                        ...
                        {/* flattened pill */}
                        <rect x="64" y="78" width="112" height="24" rx="12" className="flat-body"/>
                        {/* sleepy eyes */}
