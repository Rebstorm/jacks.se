  ...
  return (
    <>
      ...
      <section className={"card"}>
        <img
          width={128}
          src={asset("../../companies/google.png")}
          alt={"google"}
        />
        ...
        <ul>
          <li>
            Developed, maintained and improved some of Google's server code for
            client applications. This includes, but is not limited to
            technologies like TypeScript, Rust, Go, Python, CSS . It also
            includes helping with DevOps tasks like k8 orchestration, CI/CD and
            much more.
          </li>
          <li>
            Wrote RFCs for upcoming web standards as a part of the Aurora Team.
            Helped formulate the needs of Google to organizations like the W3C
            to help finalize new web APIs like the new Navigation API.
          </li>
          <li>
            Helped several external clients with their architectural structure.
            Everything from consulting on how to build a maintainable landscape,
            to actual feats like improving page rankings, to page insights,
            producing 30-50% quicker page loads.
          </li>
          <li>
            Technologies: Advanced proficiency in TypeScript, C, Go, Python &
            Rust. Developed complex applications using Deno, Lit, Polymer.js,
            CSS; and managed databases and backend operations with PostgreSQL,
            NoSQL, Redis, and Kubernetes
          </li>
        </ul>
      </section>
