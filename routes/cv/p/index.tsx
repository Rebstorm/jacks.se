  ...
  return (
    <>
      ...
      <section className={"card"}>
        ...
        <ul>
          <li>
            Guided technical and architectural decisions to ensure the
            sustainability and functionality of Tibber’s platforms. This
            included strategic planning and architectural reviews to support
            scalable and efficient system designs.
          </li>
          <li>
            Led a team of 8 software developers in establishing and maintaining
            Tibber's web presence at tibber.com. Managed project timelines,
            coordinated development tasks, and ensured delivery of high-quality
            software solutions. Based upon TypeScript, CSS, Next.js, React and
            other web technologies.
          </li>
          <li>
            Created and deployed Tibber’s own design system, enhancing user
            interface consistency and improving development efficiency across
            digital products.
          </li>
          <li>
          ...
          <li>
            Spearheaded innovative projects including Ephemeral (Preview)
            Environments, a Common Gateway for all clients using GraphQL, Design
            Tokens, and the migration of platforms to Kubernetes, optimizing
            operational workflows and infrastructure management.
          </li>

          <li>
            Technologies: Proficient in Rust,TypeScript, CSS; extensively worked
            with web technologies and cloud infrastructure including GraphQL and
            Kubernetes. Led diverse software development initiatives,
            contributing to system architectures and internal frameworks.
          </li>
        </ul>
      </section>
      ...
      <section className={"card"}>
        ...
        <ul>
          <li>
            Led a small team (4 developers) at volvocars.com that was
            responsible for the Learn domain, serving 1,000,000 page views a
            day. Main workload was teaching, planning & building the domain.
          </li>
          <li>
            Practiced the “You build it, you run it mentality” instilling
            ownership in their products. Held several seminars on different
            topics, all from, how to use certain technology, data-driven
            decision making,, to how to organize your work in an agile
            workplace.
          </li>
          <li>
            Aimed to be a multiplier by improving shared frameworks, among other
            things, creating the first typed versions of our shared component
            library, to improve developer acceptance.
          </li>
          <li>
            I spearheaded the development of creating API endpoints that would
            make development of gathering data easier for the Tribe as well.
            Creating “Hero” APIs which could be applied to speed up the
            development time.
          </li>
          <li>
            Onboarded 50&gt; engineers onto our common monorepo, was a part of
            the employment and interview board.
          </li>
          <li>Drove SLI & SLA adoption among the teams.</li>
          <li>
            Technologies: Employed React, Next.js, Kubernetes, Go, and
            TypeScript among other tools.
          </li>
        </ul>
      </section>
      <section className={"card"}>
        ...
        <ul>
          ...
          <li>
            Technologies: Specialized in Spring Boot, Angular, Java, TypeScript,
      ...
      <section>
        ...
        <p>
          ...
          ideas. I enjoy engaging in both internal and external presentations
          ...
          celebrated reaching 1800 members. I am currently engaged in delivering
          talks on cutting-edge topics like Deno, Island Architecture, and
